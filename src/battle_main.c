...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    // HnS Trainer Classes
    [TRAINER_CLASS_ARENA_TYCOON_HNS] =     { _("ARENA TYCOON") },
    ...
    [TRAINER_CLASS_BLACK_BELT_HNS] =       { _("BLACK BELT"), 8, BALL_ULTRA },
    [TRAINER_CLASS_BUG_CATCHER_HNS] =      { _("BUG CATCHER"), 4 },
    [TRAINER_CLASS_BURGLAR_HNS] =          { _("BURGLAR") },
    [TRAINER_CLASS_CAMPER_HNS] =           { _("CAMPER"), 4 },
    [TRAINER_CLASS_CHAMPION_HNS] =         { _("CHAMPION"), 50, BALL_ULTRA },
    [TRAINER_CLASS_COLLECTOR_HNS] =        { _("COLLECTOR"), 15, BALL_PREMIER },
    [TRAINER_CLASS_COOLTRAINER_HNS] =      { _("COOLTRAINER"), 12, BALL_ULTRA },
    [TRAINER_CLASS_DOME_ACE_HNS] =         { _("DOME ACE") },
    [TRAINER_CLASS_DRAGON_TAMER_HNS] =     { _("DRAGON TAMER"), 12 },
    [TRAINER_CLASS_ELITE_FOUR_HNS] =       { _("ELITE FOUR"), 25, BALL_ULTRA },
    [TRAINER_CLASS_EXPERT_HNS] =           { _("EXPERT"), 10 },
    [TRAINER_CLASS_FACTORY_HEAD_HNS] =     { _("FACTORY HEAD") },
    [TRAINER_CLASS_FIREBREATHER_HNS] =     { _("FIREBREATHER") },
    [TRAINER_CLASS_FISHERMAN_HNS] =        { _("FISHERMAN"), 10, B_TRAINER_CLASS_POKE_BALLS >= GEN_8 ? BALL_DIVE : BALL_LURE },
    ...
    [TRAINER_CLASS_PARASOL_LADY_HNS] =     { _("PARASOL LADY"), 10 },
    [TRAINER_CLASS_PICNICKER_HNS] =        { _("PICNICKER"), 4 },
    [TRAINER_CLASS_PIKE_QUEEN_HNS] =       { _("PIKE QUEEN") },
    [TRAINER_CLASS_PKMN_TRAINER_1_HNS] =   { _("{PKMN} TRAINER") },
    [TRAINER_CLASS_POKEFAN_HNS] =          { _("POKéFAN"), 20 },
    [TRAINER_CLASS_POKEMANIAC_HNS] =       { _("POKéMANIAC"), 15 },
    [TRAINER_CLASS_PSYCHIC_HNS] =          { _("PSYCHIC"), 6 },
    [TRAINER_CLASS_PSYCHIC_M_HNS] =        { _("PSYCHIC"), 6 },
    [TRAINER_CLASS_RIVAL_HNS] =            { _("{PKMN} TRAINER"), 15 },
    [TRAINER_CLASS_ROCKET_ADMIN_HNS] =     { _("ROCKET ADMIN") },
